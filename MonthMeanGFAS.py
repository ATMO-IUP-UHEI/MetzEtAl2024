#!/usr/bin/env python
# Create GFAS files with monthly fire emissions
...
# Argument Parser
def parse_arguments():
    parser = argparse.ArgumentParser(description="Script to put GFAS in one file and calculate the monthly sum")
...
inputpath = datapath + "/GFAS/cams_gfas_CO2_2009_2020_daily_1x1.nc"

#settings for the first file
#newday = True
filename = datapath + "/GFAS/cams_gfas_CO2_2009_2020_daily_1x1_monthMeans" #output file
